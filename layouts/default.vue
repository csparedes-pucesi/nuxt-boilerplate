				...
				<ul class="space-y-2 font-medium">
					...
					v-for="(padre, index) in [
						...
						},
						{
							...
							ruta_url: '/empresas',
							ruta_component:
								'/modules/consultoria/pages/EmpresasPage.vue',
							ruta_indexed: false,
							roru_privilegio: 1,
						},
					]" :key="index">
					...
					<li class="mt-4">
						<UButton 
							type="button" 
							icon="heroicons:arrow-right-start-on-rectangle" label="Cerrar Sesión"
							@click="logout" />
					</li>
				</ul>
			</div>
				...
				<div class="p-3">
					<div class="flex items-center justify-between">
						...
						<div class="flex items-center justify-start rtl:justify-end">
							<UButton 
							type="button" icon="heroicons:bars-3-bottom-left-20-solid"
								@click="toggleSidebar" />
							<NuxtImg 
							class="m-0" src="/logo-puce-i.png" alt="logo-puce" width="160" height="40"
