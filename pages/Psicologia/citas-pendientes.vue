...
const citasPendientes = ref<Cita[]>([])
const origen = ref('datos-Pendientes')

onMounted(() => {
  citasPendientes.value = [
    {
      id: '1',
      title: 'Consulta de control (PENDIENTE)',
      start: '2025-02-15T08:00:00',
      end: '2025-02-15T08:10:00',
    ...
    {
      id: '2',
      title: 'Chequeo oftalmológico (PENDIENTE)',
    ...
    {
      id: '3',
      title: 'Consulta dermatológica (PENDIENTE)',
    ...
    {
      id: '4',
      title: 'Sesión de fisioterapia (PENDIENTE)',
    ...
    {
      id: '5',
      title: 'Consulta odontológica (PENDIENTE)',
    ...
    {
      id: '6',
      title: 'Evaluación cardiológica (PENDIENTE)',
    ...
    {
      id: '7',
      title: 'Consulta ginecológica (PENDIENTE)',
    ...
    {
      id: '8',
      title: 'Revisión odontológica (PENDIENTE)',
    ...
    {
      id: '9',
      title: 'Chequeo pediátrico (PENDIENTE)',
    ...
    {
      id: '10',
      title: 'ReTerapia psicológica (PENDIENTE)',
      start: '2025-02-28T11:00:00',
      end: '2025-02-28T12:30:00',
    ...
    {
      id: '11',
      title: 'ReConsulta de nutrición (PENDIENTE)',
    ...
    {
      id: '12',
      title: 'Revisión postoperatoria (PENDIENTE)',
